...
/* Include files */
#include "_coder_GPReduce_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, (const char_T *)"Name",
                emlrtMxCreateString((const char_T *)"GPReduce"));
  ...
  emlrtSetField(
      ...
      emlrtMxCreateString(
          (const char_T
               *)"/Users/natasha/Downloads/TBM_software/TBM/GP/GPReduce.m"));
  emlrtSetField(xEntryPoints, 0, (const char_T *)"TimeStamp",
                emlrtMxCreateDoubleScalar(736524.36027777777));
  xResult =
...
/* End of code generation (_coder_GPReduce_info.c) */
