...
void GPExpand_api(const mxArray *const prhs[2], const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  emxInit_real_T(&st, &b_I, 3, &m_emlrtRTEI);
  emxInit_real_T(&st, &IResult, 3, &m_emlrtRTEI);
  ...
  GPExpand(&st, b_I, *newdim, IResult);
