...
Let <img src="http://www.sciweavers.org/tex2img.php?eq=s%28%5Cmathbf%7Bx%7D%29%2C%20%5Cmathbf%7Bx%7D%5Cin%5Cmathbb%7BR%7D&bc=White&fc=Black&im=ps&fs=14&ff=anttor&edit=0" align="center" border="0" alt="s(\mathbf{x}), \mathbf{x}\in\mathbb{R}" width="" height="" /> be a positive density function (PDF).
