...
Let <img src="https://latex.codecogs.com/svg.latex?s(\mathbf{x}),&space;\mathbf{x}\in\mathbb{R}" title="s(\mathbf{x}), \mathbf{x}\in\mathbb{R}" /> be a posititive density function (PDF).
